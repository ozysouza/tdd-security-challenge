package com.desouza.app.config;
...
import com.desouza.app.config.customgrant.CustomPasswordAuthenticationConverter;
import com.desouza.app.config.customgrant.CustomPasswordAuthenticationProvider;
import com.desouza.app.config.customgrant.CustomUserAuthorities;
...
public class AuthorizationServerConfig {
	...
	public SecurityFilterChain asSecurityFilterChain(HttpSecurity http) throws Exception {
		RequestMatcher authorizationServerEndpointsMatcher = request -> {
